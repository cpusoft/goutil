...
func TestGetHttpsVerifyWithConfig(t *testing.T) {
	...
	resp, body, err := GetHttpsVerifyWithConfig(url, true, NewHttpClientConfigWithParam(5, 3, "all", true))
...
func TestGetHttpsResponseVerifyWithConfig(t *testing.T) {
	...
	resp, _ := GetHttpsVerifyResponseWithConfig(url, true, NewHttpClientConfigWithParam(5, 3, "all", true))
...
func TestGetHttpsRangeVerifyWithConfig(t *testing.T) {
	...
	_, supportRange, contentLength, err := GetHttpsVerifySupportRangeWithConfig(url, true, NewHttpClientConfigWithParam(5, 3, "all", true))
	if err != nil {
		fmt.Println("err:", err)
		return
	}
	...
	resp, body, err := GetHttpsVerifyRangeWithConfig(url, contentLength,
		10000000, true, NewHttpClientConfigWithParam(5, 3, "all", true))
