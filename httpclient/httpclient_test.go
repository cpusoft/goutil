...
func TestGetHttpsVerifyWithConfig(t *testing.T) {
	...
	resp, body, err := GetHttpsVerifyWithConfig(url, NewHttpClientConfigWithParam(5, 3, "all", true))
...
func TestGetHttpsResponseVerifyWithConfig(t *testing.T) {
	...
	resp, _ := GetHttpsVerifyResponseWithConfig(url, NewHttpClientConfigWithParam(5, 3, "all", true))
...
func TestGetHttpsRangeVerifyWithConfig(t *testing.T) {
	...
	_, supportRange, contentLength, err := GetHttpsVerifySupportRangeWithConfig(url, NewHttpClientConfigWithParam(5, 3, "all", true))
	if err != nil {
		fmt.Println("err:", err)
		return
	}
