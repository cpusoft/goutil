...
/*
// Deprecated: not use tls; WithServerTLS 启用TLS配置
...
/*
// // Deprecated: not use tls; buildTLSConfig 构建TLS配置
...
func (ts *TcpServer) Start(addr string) error {
	...
	belogs.Info("TcpServer.Start(): Server started, addr:", addr, " isTLS:", ts.isTLS)
