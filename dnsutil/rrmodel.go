...
type RrModel struct {
	...
	RrTtl   uint32 `json:"rrTtl" xorm:"rrTtl int"`
...
func ConvertRrToPacketModel(originModel OriginModel, rrModel RrModel) (rrPacketModel *RrPacketModel, err error) {
	...
	rrPacketTtl := rrModel.RrTtl
	if rrPacketTtl == 0 {
		rrPacketTtl = originModel.Ttl
	}
